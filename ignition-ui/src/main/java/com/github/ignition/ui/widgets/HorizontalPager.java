package com.github.ignition.ui.widgets;
...
import com.github.ignition.ui.R;

/**
 * Kindly donated to the ignition project by Jean Guy.
 * 
...
public class HorizontalPager extends ViewGroup {
    ...
    public HorizontalPager(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.com_github_ignition_ui_widgets_HorizontalPager);
        pageWidthSpec = a.getDimensionPixelSize(
                R.styleable.com_github_ignition_ui_widgets_HorizontalPager_pageWidth,
                SPEC_UNDEFINED);
        a.recycle();
